...
export default function ContactPage() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			const text = `🆕 Yangi murojat!\n\n👤 Ism: ${formData.name}\n📞 Telefon raqam: ${formData.phone}\n✉️ Habar: ${formData.message}`
								...
								<div className='space-y-6'>
									...
									<div className='flex items-start gap-4'>
										...
										<div>
											...
											<a href='tel:+998712330714' className='text-base text-gray-600 dark:text-gray-300 hover:text-green-600 block mb-1'>
												+998 (71) 233-06-18
											</a>
