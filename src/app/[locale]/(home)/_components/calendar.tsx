...
export function CalendarDemo() {
	...
	return (
		<div className='space-y-4 h-full flex flex-col'>
			...
			<div className='rounded-md dark:border-none border p-4 shadow w-full dark:bg-blue-800/40 bg-white flex-grow'>
				<h3 className='font-bold mb-2 text-blue-600 dark:text-white text-lg'>
					Yangiliklar:
				</h3>
				{loading ? (
					<p>Yuklanmoqda...</p>
