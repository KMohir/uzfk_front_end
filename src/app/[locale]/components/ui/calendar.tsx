	...
	return (
		<DayPicker
			...
			classNames={{
				...
				head_row: 'flex',
				head_cell:
					'text-blue-900 text-base rounded-md w-12 font-semibold', // Katta shrift
				...
				day: cn(
					...
					'h-12 w-12 p-0 font-semibold text-lg aria-selected:opacity-100 text-blue-500' // Kattaroq kunlar
				),
