	...
	const handleTabChange = (
		...
		setWorkers(prevWorkers =>
			prevWorkers.map(worker =>
				worker.id === workerId
					? { ...worker, currentTab: worker.currentTab === tab ? null : tab }
					: worker
			)
		)
	}
	...
	return (
		<section className='bg-[#f8f9fa] dark:bg-gray-600 body-font'>
			<div className='container px-2 md:px-9 py-4 mx-auto'>
				<Link
					href={'/center-units'}
					className='text-2xl flex gap-1 group items-center font-medium text-blue-600 dark:text-blue-500'
				>
					{t('nav7')}{' '}
							...
							>
								...
								<div className='mt-6 border-t pt-4'>
									...
									<div className='mt-6'>
										...
										{worker.currentTab === 'workers' && worker.targets && (
											<div className='mt-6 space-y-4'>
												{worker.targets.map(subWorker => (
													<div
														key={subWorker.id}
